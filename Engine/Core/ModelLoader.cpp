...
)
{
	...
	if (file == NULL)
	{
		printf("Impossible to open the file! Are you in the righr path?\n");
		getchar();
		return false;
	}
	...
	for (unsigned int i = 0; i < vertexIndices.size(); i++) {
		...
		glm::vec3 noraml = temp_normals[normalIndex - 1];
...
bool ModelLoader::getSimilarVertexIndex(
	glm::vec3 & in_vertex,
	glm::vec2 & in_uv,
	glm::vec3 & in_normal,
	std::vector<glm::vec3> & out_vertices,
...
void ModelLoader::indexVBO_slow(
